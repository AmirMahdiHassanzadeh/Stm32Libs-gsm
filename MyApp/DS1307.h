 ...
 */
#define DS1307_MASK_SECOND 0x7F
#define DS1307_MASK_MINUTE 0x7F
#define DS1307_MASK_HOUR 0x3F
#define DS1307_MASK_DAY_OF_WEEK 0x07
#define DS1307_MASK_DAY_OF_MONTH 0x3F
#define DS1307_MASK_MONTH 0x1F
#define DS1307_MASK_YEAR 0xFF

/**
 * Clock Halt (CH) - register DS1307_REGISTER_SECOND (0x00).
 * When this bit is set to 1 RTC was halt - default state.
 */
#define DS1307_FLAG_0X00_CH 0x40
/**
 * 12/24 mode - register DS1307_REGISTER_HOUR (0x02)
 */
#define DS1307_FLAG_0X02_24 0x20
/*
 * Bit sets enable / disable square wave output.
 */
#define DS1307_FLAG_SQWE 0x10
 ...
 */
#define DS1307_SQW_1_HZ 0x10
#define DS1307_SQW_4_KHZ 0x11
#define DS1307_SQW_8_KHZ 0x12
#define DS1307_SQW_32_KHZ 0x13
